...
# ===============================
# Pre-registers clickstream schema with CEL rules and creates DLQ topic.
# Instructor-led path: CDC topic prefix, only clickstream schema registered.
