...
>
> If you encounter "Access is Denied" or "Permission denied" errors on Windows, you should run this workshop from **WSL 2** instead of PowerShell. See the [Windows setup instructions in LAB 0](../LAB0_prerequisites/LAB0.md#initial-setup-steps) for details.
>
