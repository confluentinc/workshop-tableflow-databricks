...
4. Click the **Disable Tableflow** link
   ...
   ![Topic configuration page](../../shared/images/tableflow_disable_topic.png)

5. Copy and paste the topic name into the field and click **Confirm**
6. Repeat steps 1-5 for the `clickstream` and `hotel_reviews_with_sentiment` topics
...
Now that you've completed all of the labs that comprise this workshop, review [this recap](../../shared/recap.md) of what you've accomplished.
