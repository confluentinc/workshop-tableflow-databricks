...
>
> We recommend that you run this workshop from a **WSL 2 terminal** (not PowerShell). See the [Windows setup instructions](../../README.md#step-2-pull-and-build-docker-images) if you haven't configured this yet.
