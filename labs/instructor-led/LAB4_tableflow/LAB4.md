...
7. Enter a short and useful value in the *Namespace*, like `riverhotel`

   ![Form with multi-select and a name and supported format field](../../shared/images/tableflow_unity_catalog_integration1.png)

8. Click **Continue**
9. Enter the connection details from your credentials email:
...
10. Click **Continue**
11. Launch your Unity Catalog integration
...
- Writes converted data to your specified cloud storage location
...
10. Copy and paste the `Cloud Storage Name` from your credentials email into the *AWS S3 Bucket/Azure storage account name* textbox
...
You have configured the integration between Confluent Cloud Tableflow and Databricks Unity Catalog, enabled Tableflow on three topics — `riverhotel.cdc.clickstream`, `denormalized_hotel_bookings`, and `reviews_with_sentiment` — and verified that data is syncing as Delta Lake tables.
